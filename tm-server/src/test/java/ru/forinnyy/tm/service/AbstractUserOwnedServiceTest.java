...
public abstract class AbstractUserOwnedServiceTest<M extends AbstractUserOwnedModel, R extends IUserOwnedRepository<M>>
    ...
    public void testFindOneByIdAndIndex() {
        ...
        Assert.assertThrows(
                UserIdEmptyException.class, () -> getUserOwnedService().findOneById(null, model.getId()));
        Assert.assertThrows(
                UserIdEmptyException.class, () -> getUserOwnedService().findOneById(EMPTY_STRING, model.getId()));

        Assert.assertThrows(
                IdEmptyException.class, () -> getUserOwnedService().findOneById(UUID1, null));
        Assert.assertThrows(
                IdEmptyException.class, () -> getUserOwnedService().findOneById(UUID1, EMPTY_STRING));

        Assert.assertThrows(
                UserIdEmptyException.class, () -> getUserOwnedService().findOneByIndex(null, 0));
        Assert.assertThrows(
                UserIdEmptyException.class, () -> getUserOwnedService().findOneByIndex(EMPTY_STRING, 0));

        Assert.assertThrows(
                IndexIncorrectException.class, () -> getUserOwnedService().findOneByIndex(UUID1, null));
    }
    ...
    public void testExistsById() {
        ...
        Assert.assertThrows(
                UserIdEmptyException.class, () -> getUserOwnedService().existsById(null, model.getId()));
        Assert.assertThrows(
                UserIdEmptyException.class, () -> getUserOwnedService().existsById(EMPTY_STRING, model.getId()));

        Assert.assertThrows(
                IdEmptyException.class, () -> getUserOwnedService().existsById(UUID1, null));
        Assert.assertThrows(
                IdEmptyException.class, () -> getUserOwnedService().existsById(UUID1, EMPTY_STRING));
    }
    ...
    public void testGetSize() {
        ...
        Assert.assertThrows(
                UserIdEmptyException.class, () -> getUserOwnedService().getSize(null));
        Assert.assertThrows(
                UserIdEmptyException.class, () -> getUserOwnedService().getSize(EMPTY_STRING));
    }
    ...
    public void testRemoveById() {
        ...
        Assert.assertThrows(
                UserIdEmptyException.class, () -> getUserOwnedService().removeById(null, model.getId()));
        Assert.assertThrows(
                UserIdEmptyException.class, () -> getUserOwnedService().removeById(EMPTY_STRING, model.getId()));

        Assert.assertThrows(
                IdEmptyException.class, () -> getUserOwnedService().removeById(UUID1, null));
        Assert.assertThrows(
                IdEmptyException.class, () -> getUserOwnedService().removeById(UUID1, EMPTY_STRING));
    }
    ...
    public void testRemoveByIndex() {
        ...
        Assert.assertThrows(
                UserIdEmptyException.class, () -> getUserOwnedService().removeByIndex(null, 0));
        Assert.assertThrows(
                UserIdEmptyException.class, () -> getUserOwnedService().removeByIndex(EMPTY_STRING, 0));

        Assert.assertThrows(
                IndexIncorrectException.class, () -> getUserOwnedService().removeByIndex(UUID1, null));
    }
